...
public class CommitData {
    ...
    public CommitData(final String key, final String message, final String userInfo, final String userMail) {
        this(null, key, message, userInfo, userMail);
    }

    public CommitData(final String branch, final String key, final String message, final String userInfo, final String userMail) {
